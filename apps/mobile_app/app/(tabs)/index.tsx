          ...
          {!user?.isActive ? (
            <View className="mb-6">
              <View className="bg-red-500/10 rounded-2xl p-4 border border-red-500/30">
                ...
                <Pressable className="rounded-xl overflow-hidden active:opacity-90">
                  <LinearGradient
            ...
            <BottomSheetView style={styles.contentContainer}>
              ...
              <View className="flex-row gap-3 w-full px-6">
                ...
                <Pressable
                  ...
                  className="flex-1 bg-card/50 border border-border rounded-xl py-3.5 items-center active:opacity-70"
                >
                ...
                <Pressable
                  ...
                  disabled={isLoading}
                  className="flex-1 bg-red-500 rounded-xl py-3.5 items-center active:opacity-80"
                >
